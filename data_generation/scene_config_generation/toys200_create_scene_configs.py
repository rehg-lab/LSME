...
DATASET = "toys200" # toys, shapenet or modelnet
# ASSET_JSON_FILE = "../common/jsons/scene_assets_new.json"
ASSET_JSON_FILE = "../common/jsons/scene_assets_add.json"

OBJ_JSON_FILE = "../common/jsons/{}_dict.json".format(DATASET)
OBJ_POSE_DIR = "../common/{}_poses_canonical".format(DATASET)
OUTPUT_DIR = "/data/DevLearning/odme/{}_scene_configs_single_test".format(DATASET)
N_FRAMES = 20
N_START = 1000
N_SCENES = 1000
OBJ_X_MIN = -0.2
...
def main():
    ...
    # hdr_files = [x for x in hdr_files if x in hdr_files]
    # pbr_files = [x for x in pbr_files if x in pbr_files]
